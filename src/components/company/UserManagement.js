...
const UserManagement = () => {
  ...
  const { users = { items: [], totalItems: 0 }, loading } = useSelector(
    (state) => state.company || {}
  );
  ...
  const activeUsers =
    users?.items?.filter((user) => user?.isActive).length || 0;
  const adminUsers =
    users?.items?.filter((user) => user?.role === "company_admin").length || 0;
  ...
  const handleAddUserSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        // If server sends a specific error message
          ...
          <CardBody p={6}>
            ...
            >
              <TableContainer>
                <Table variant="unstyled">
                  <Thead>
                    <Tr>
                      <Td color="gray.400" fontWeight="bold" py={4}>
                        User
                      </Td>
                      <Td color="gray.400" fontWeight="bold">
                        Role
                      </Td>
                      <Td color="gray.400" fontWeight="bold">
                        Status
            ...
            <HStack justify="space-between" align="center" mt={6}>
              <Text fontSize="sm" color="gray.400">
                ...
                {Math.min((page + 1) * rowsPerPage, users?.totalItems || 0)} of{" "}
                {users?.totalItems || 0} users
              </Text>
              <HStack>
                <Button
                  size="sm"
                ...
                <Button
                  ...
                  onClick={() => setPage(page + 1)}
                  isDisabled={
                    (page + 1) * rowsPerPage >= (users?.totalItems || 0)
                  }
                  variant="outline"
                  borderColor="whiteAlpha.200"
                  color="gray.300"
                  ...
                  >
                    ...
                    <Box>
                      ...
                      <Text fontSize="sm" color="gray.300">
                        The user will receive login credentials and can change
